        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
                ...
                child: Carousel(
                  images: [
                    NetworkImage('https://media.gettyimages.com/photos/colorful-fresh-organic-vegetables-picture-id882314812'),
                    NetworkImage('https://previews.123rf.com/images/puhhha/puhhha1805/puhhha180500313/100520940-healthy-food-fresh-organic-vegetables-on-white-wooden-background-high-resolution.jpg'),
                    NetworkImage('https://previews.123rf.com/images/puhhha/puhhha1805/puhhha180500313/100520940-healthy-food-fresh-organic-vegetables-on-white-wooden-background-high-resolution.jpg'),
                    NetworkImage('https://media.gettyimages.com/photos/colorful-fresh-organic-vegetables-picture-id882314812')
                  ],
                  dotSize: 4.0,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Shop by category',style: GoogleFonts.lato(fontSize: 18.0,fontWeight: FontWeight.bold),),
                Text('View all',style: GoogleFonts.lato(fontSize: 13.0,fontWeight: FontWeight.bold)),
